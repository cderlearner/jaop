...
import com.github.aop.exception.WeaveArgumentException;
...
public class Assert {
	...
	public static void notNull(Object object, String message) {
		if (object == null) {
			throw new WeaveArgumentException(message);
		}
	}
	...
	public static void isInstanceOf(Class<?> type, Object obj, String message) {
		...
		if (!type.isInstance(obj)) {
			throw new WeaveArgumentException(
	...
	public static void isAssignable(Class<?> superType, Class<?> subType, String message) {
		...
		if (subType == null || !superType.isAssignableFrom(subType)) {
			throw new WeaveArgumentException(message + subType + " is not assignable to " + superType);
		}
	}
