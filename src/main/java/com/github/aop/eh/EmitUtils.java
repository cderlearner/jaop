...
//                net.sf.cglib.core.CodeEmitter hook = ce.getStaticHook();
//                hook.push(typeName);
...
//    /**
//     * @deprecated use {@link #hash_code(net.sf.cglib.core.CodeEmitter, Type, int, CustomizerRegistry)} instead
//     */
//    @Deprecated
//    public static void hash_code(net.sf.cglib.core.CodeEmitter e, Type type, int multiplier, final Customizer customizer) {
//    	hash_code(e, type, multiplier, CustomizerRegistry.singleton(customizer));
//    }
//
//    public static void hash_code(net.sf.cglib.core.CodeEmitter e, Type type, int multiplier, final CustomizerRegistry registry) {
...
//    private static void hash_array(final net.sf.cglib.core.CodeEmitter e, Type type, final int multiplier, final CustomizerRegistry registry) {
...
//    private static void hash_object(net.sf.cglib.core.CodeEmitter e, Type type, CustomizerRegistry registry) {
//        // (f == null) ? 0 : f.hashCode();
//        Label skip = e.make_label();
//        Label end = e.make_label();
//        e.dup();
...
//    /**
//     * @deprecated use {@link #not_equals(net.sf.cglib.core.CodeEmitter, Type, Label, CustomizerRegistry)} instead
//     */
//    @Deprecated
//    public static void not_equals(net.sf.cglib.core.CodeEmitter e, Type type, final Label notEquals, final Customizer customizer) {
...
//     */
//    public static void not_equals(final net.sf.cglib.core.CodeEmitter e, Type type, final Label notEquals, final CustomizerRegistry registry) {
...
//    }
//
//    private static void not_equals_helper(net.sf.cglib.core.CodeEmitter e,
//                                          Type type,
//                                          Label notEquals,
...
//    /**
//      * @deprecated use {@link #append_string(net.sf.cglib.core.CodeEmitter, Type, ArrayDelimiters, CustomizerRegistry)} instead
//      */
//    @Deprecated
//    public static void append_string(final net.sf.cglib.core.CodeEmitter e,
//                                     Type type,
...
//    private static void append_string_helper(net.sf.cglib.core.CodeEmitter e,
//                                             Type type,
//                                             ArrayDelimiters delims,
//                                             CustomizerRegistry registry,
//                                             ProcessArrayCallback callback) {
...
//    private static void member_helper_size(final net.sf.cglib.core.CodeEmitter e,
//                                           List members,
//                                           final ObjectSwitchCallback callback,
